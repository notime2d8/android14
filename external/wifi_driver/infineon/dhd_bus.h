...
#ifdef BCMDHDX
extern int dhdx_dongle_mem_dump_infineon(void);
#else
extern int dhd_dongle_mem_dump_infineon(void);
#endif /* BCMDHDX */
...
#ifndef BCMDHDX
extern bool dhd_bus_check_driver_up_infineon(void);
#else
extern bool dhdx_bus_check_driver_up_infineon(void);
#endif /* BCMDHDX */
...
static INLINE bool dhd_bus_check_driver_up_infineon(void) { return FALSE; }
