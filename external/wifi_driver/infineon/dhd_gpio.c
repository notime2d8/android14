 ...
 *
 *
 * $Id: dhd_gpio 697969 2024-04-19 16:36:11Z $
 */
#include <osl.h>
#include <dhd_linux.h>
...
#endif
#if defined(CUSTOMER_HW_ROCKCHIP) || defined(CUSTOMER_HW_ROCKCHIP_POWER)
...
dhd_wlan_set_power(int on, wifi_adapter_info_t *adapter)
{
	...
	if (on) {
		printf("rockhcip wlan_set_power on\n");
...
//		rk_pcie_power_on_atu_fixup();
		...
		printf("rockchip dhd_wlan_set_power off\n");
#if defined(CUSTOMER_HW_ROCKCHIP) || defined(CUSTOMER_HW_ROCKCHIP_POWER)
