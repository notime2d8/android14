...
static const struct id_table ic_id_table[] = {
	...
	{ IC_INFO(RTL_ROM_LMP_8723B, 0xb, 0x6, HCI_UART),
	  ...
	  .fw_name  = "rtl8723bs_fw",
	  .cfg_name = "rtl8723bs_config" },
	...
	{ .match_flags = IC_MATCH_FL_LMPSUBV | IC_MATCH_FL_CHIP_TYPE |
	  ...
	  .config_needed = true,
	  .has_rom_version = true,
	  .fw_name  = "rtl8723cs_cg_fw",
	  .cfg_name = "rtl8723cs_cg_config" },
	...
	{ .match_flags = IC_MATCH_FL_LMPSUBV | IC_MATCH_FL_CHIP_TYPE |
	  ...
	  .config_needed = true,
	  .has_rom_version = true,
	  .fw_name  = "rtl8723cs_vf_fw",
	  .cfg_name = "rtl8723cs_vf_config" },
	...
	{ .match_flags = IC_MATCH_FL_LMPSUBV | IC_MATCH_FL_CHIP_TYPE |
	  ...
	  .config_needed = true,
	  .has_rom_version = true,
	  .fw_name  = "rtl8723cs_xx_fw",
	  .cfg_name = "rtl8723cs_xx_config" },
	...
	{ IC_INFO(RTL_ROM_LMP_8723B, 0xd, 0x8, HCI_USB),
	  ...
	  .has_rom_version = true,
	  .fw_name  = "rtl8723d_fw",
	  .cfg_name = "rtl8723d_config" },

	/* 8723DS */
	{ IC_INFO(RTL_ROM_LMP_8723B, 0xd, 0x8, HCI_UART),
	  .config_needed = true,
	  .has_rom_version = true,
	  .fw_name  = "rtl8723ds_fw",
	  .cfg_name = "rtl8723ds_config" },
	...
	{ IC_INFO(RTL_ROM_LMP_8852A, 0xa, 0xb, HCI_USB),
	  ...
	  .has_rom_version = true,
	  .has_msft_ext = true,
	  .fw_name  = "rtl8852au_fw",
	  .cfg_name = "rtl8852au_config" },
	...
	{ IC_INFO(RTL_ROM_LMP_8852A, 0xc, 0xc, HCI_USB),
	  ...
	  .has_rom_version = true,
	  .has_msft_ext = true,
	  .fw_name  = "rtl8852cu_fw",
	  .cfg_name = "rtl8852cu_config" },
	...
	{ IC_INFO(RTL_ROM_LMP_8851B, 0xb, 0xc, HCI_USB),
	  ...
	  .has_rom_version = true,
	  .has_msft_ext = false,
	  .fw_name  = "rtl8851bu_fw",
	  .cfg_name = "rtl8851bu_config" },
	};
...
MODULE_LICENSE("GPL");
MODULE_FIRMWARE("rtl8723a_fw");
MODULE_FIRMWARE("rtl8723b_fw");
MODULE_FIRMWARE("rtl8723b_config");
MODULE_FIRMWARE("rtl8723bs_fw");
MODULE_FIRMWARE("rtl8723bs_config");
MODULE_FIRMWARE("rtl8723cs_cg_fw");
MODULE_FIRMWARE("rtl8723cs_cg_config");
MODULE_FIRMWARE("rtl8723cs_vf_fw");
MODULE_FIRMWARE("rtl8723cs_vf_config");
MODULE_FIRMWARE("rtl8723cs_xx_fw");
MODULE_FIRMWARE("rtl8723cs_xx_config");
MODULE_FIRMWARE("rtl8723d_fw");
MODULE_FIRMWARE("rtl8723d_config");
MODULE_FIRMWARE("rtl8723ds_fw");
MODULE_FIRMWARE("rtl8723ds_config");
MODULE_FIRMWARE("rtl8761a_fw");
MODULE_FIRMWARE("rtl8761a_config");
MODULE_FIRMWARE("rtl8761b_fw");
MODULE_FIRMWARE("rtl8761b_config");
MODULE_FIRMWARE("rtl8761bu_fw");
MODULE_FIRMWARE("rtl8761bu_config");
MODULE_FIRMWARE("rtl8821a_fw");
MODULE_FIRMWARE("rtl8821a_config");
MODULE_FIRMWARE("rtl8821c_fw");
MODULE_FIRMWARE("rtl8821c_config");
MODULE_FIRMWARE("rtl8821cs_fw");
MODULE_FIRMWARE("rtl8821cs_config");
MODULE_FIRMWARE("rtl8822b_fw");
MODULE_FIRMWARE("rtl8822b_config");
MODULE_FIRMWARE("rtl8822cs_fw");
MODULE_FIRMWARE("rtl8822cs_config");
MODULE_FIRMWARE("rtl8822cu_fw");
MODULE_FIRMWARE("rtl8822cu_config");
MODULE_FIRMWARE("rtl8851bu_fw");
MODULE_FIRMWARE("rtl8851bu_config");
MODULE_FIRMWARE("rtl8852au_fw");
MODULE_FIRMWARE("rtl8852au_config");
MODULE_FIRMWARE("rtl8852bu_fw");
MODULE_FIRMWARE("rtl8852bu_config");
MODULE_FIRMWARE("rtl8852cu_fw");
MODULE_FIRMWARE("rtl8852cu_config");
