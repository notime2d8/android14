...
deps_drivers/media/platform/rockchip/cif/dev.o := \
    ...
    $(wildcard include/config/ROCKCHIP_CIF_USE_MONITOR) \
    $(wildcard include/config/ROCKCHIP_CIF_MONITOR_MODE) \
    $(wildcard include/config/ROCKCHIP_CIF_MONITOR_KEEP_TIME) \
    $(wildcard include/config/ROCKCHIP_CIF_MONITOR_CYCLE) \
    $(wildcard include/config/ROCKCHIP_CIF_MONITOR_START_FRAME) \
    $(wildcard include/config/ROCKCHIP_CIF_MONITOR_ERR_CNT) \
    $(wildcard include/config/ROCKCHIP_CIF_RESET_BY_USER) \
    $(wildcard include/config/ROCKCHIP_CIF_WORKMODE_PINGPONG) \
    $(wildcard include/config/ROCKCHIP_CIF_WORKMODE_ONEFRAME) \
    $(wildcard include/config/ROCKCHIP_CIF_USE_DUMMY_BUF) \
  ...
  include/linux/soc/rockchip/rockchip_thunderboot_service.h \
    $(wildcard include/config/ROCKCHIP_THUNDER_BOOT_SERVICE) \
...
$(deps_drivers/media/platform/rockchip/cif/dev.o):
#SYMVER rkcif_plat_drv 0xe695cd47
