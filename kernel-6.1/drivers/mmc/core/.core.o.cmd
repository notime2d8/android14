...
deps_drivers/mmc/core/core.o := \
    ...
    $(wildcard include/config/ROCKCHIP_THUNDER_BOOT_MMC) \
...
$(deps_drivers/mmc/core/core.o):
#SYMVER mmc_command_done 0xa1e77b2f
#SYMVER mmc_request_done 0x7da5a4c7
#SYMVER mmc_start_request 0x4735e9ca
#SYMVER mmc_wait_for_req_done 0x64ad9717
#SYMVER mmc_cqe_start_req 0x600e4126
#SYMVER mmc_cqe_request_done 0x568a0640
#SYMVER mmc_cqe_post_req 0x63da603d
#SYMVER mmc_cqe_recovery 0xdaa5b1e7
#SYMVER mmc_is_req_done 0x41ea11ed
#SYMVER mmc_wait_for_req 0x7907ec36
#SYMVER mmc_wait_for_cmd 0x290582b5
#SYMVER mmc_set_data_timeout 0x96bbfd81
#SYMVER __mmc_claim_host 0x288f066c
#SYMVER mmc_release_host 0xa99d0f73
#SYMVER mmc_get_card 0x02597099
#SYMVER mmc_put_card 0x8dc5679c
#SYMVER mmc_set_clock 0x7b2d6f11
#SYMVER mmc_execute_tuning 0x0e2a06b1
#SYMVER mmc_set_bus_mode 0x46830de9
#SYMVER mmc_set_bus_width 0xf5def1e8
#SYMVER mmc_set_initial_state 0xb19b7574
#SYMVER mmc_set_timing 0x66044ba2
#SYMVER mmc_detect_change 0xd0986dcd
#SYMVER mmc_erase 0x8918715a
#SYMVER mmc_can_erase 0xc2a2b27d
#SYMVER mmc_can_trim 0xad29abe3
#SYMVER mmc_can_discard 0x4060a328
#SYMVER mmc_can_secure_erase_trim 0xd30cc6b3
#SYMVER mmc_erase_group_aligned 0xe8ffd99b
#SYMVER mmc_calc_max_discard 0x234e687c
#SYMVER mmc_card_is_blockaddr 0x2c6aeb9a
#SYMVER mmc_set_blocklen 0x0c6a9977
#SYMVER mmc_hw_reset 0xfa017a49
#SYMVER mmc_sw_reset 0xee1d1a17
#SYMVER mmc_detect_card_removed 0x18fdc570
#SYMVER mmc_card_alternative_gpt_sector 0x1b7432ec
