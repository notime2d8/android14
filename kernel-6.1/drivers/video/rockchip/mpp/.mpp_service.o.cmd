...
deps_drivers/video/rockchip/mpp/mpp_service.o := \
    $(wildcard include/config/ROCKCHIP_MPP_RKVDEC) \
    $(wildcard include/config/ROCKCHIP_MPP_RKVENC) \
    $(wildcard include/config/ROCKCHIP_MPP_VDPU1) \
    $(wildcard include/config/ROCKCHIP_MPP_VEPU1) \
    $(wildcard include/config/ROCKCHIP_MPP_VDPU2) \
    $(wildcard include/config/ROCKCHIP_MPP_VEPU2) \
    $(wildcard include/config/ROCKCHIP_MPP_VEPU22) \
    $(wildcard include/config/ROCKCHIP_MPP_IEP2) \
    $(wildcard include/config/ROCKCHIP_MPP_JPGDEC) \
    $(wildcard include/config/ROCKCHIP_MPP_JPGENC) \
    $(wildcard include/config/ROCKCHIP_MPP_RKVDEC2) \
    $(wildcard include/config/ROCKCHIP_MPP_RKVENC2) \
    $(wildcard include/config/ROCKCHIP_MPP_AV1DEC) \
    $(wildcard include/config/ROCKCHIP_MPP_VDPP) \
