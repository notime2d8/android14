...
#define TSK_STACK_CANARY 1200 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 2576 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 3568 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_MTE_CTRL 3560 /* offsetof(struct task_struct, thread.mte_ctrl) */
