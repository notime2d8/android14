...
deps_kernel/sched/core.o := \
    ...
    $(wildcard include/config/ROCKCHIP_PERFORMANCE) \
    ...
    $(wildcard include/config/ROCKCHIP_OPTIMIZE_RT_PRIO) \
...
$(deps_kernel/sched/core.o):
#SYMVER runqueues 0x5468af90
#SYMVER sysctl_sched_features 0x84da85bb
#SYMVER raw_spin_rq_lock_nested 0x7f951be0
#SYMVER raw_spin_rq_unlock 0x0d9b58ff
#SYMVER double_rq_lock 0x2c69ce8a
#SYMVER __task_rq_lock 0x90863109
#SYMVER task_rq_lock 0xd5bd9e95
#SYMVER update_rq_clock 0x2aff81b7
#SYMVER resched_curr 0xe64d527a
#SYMVER sched_uclamp_used 0x056a37c5
#SYMVER uclamp_eff_value 0x6969f810
#SYMVER activate_task 0xf9d35aa5
#SYMVER deactivate_task 0xe04079dd
#SYMVER check_preempt_curr 0xd0435c44
#SYMVER migrate_disable 0x49608959
#SYMVER migrate_enable 0x4d7272e4
#SYMVER __migrate_task 0x51a5319e
#SYMVER push_cpu_stop 0x99bd5133
#SYMVER set_cpus_allowed_ptr 0xb21dc3ce
#SYMVER set_task_cpu 0x68291c90
#SYMVER migrate_swap 0x68eaf70b
#SYMVER kick_process 0xa9ef6387
#SYMVER select_fallback_rq 0x84f62855
#SYMVER wake_up_if_idle 0xf6abaae1
#SYMVER wake_up_process 0x700aff5f
#SYMVER wake_up_state 0x08a63dfe
#SYMVER balance_push_callback 0x3bba9aa5
#SYMVER __balance_callbacks 0x81a4af08
#SYMVER nr_running 0x909a8abf
...
#SYMVER set_user_nice 0x61745d85
#SYMVER available_idle_cpu 0x2088e082
#SYMVER sched_setscheduler 0x1c58c860
#SYMVER sched_setattr 0xe6e2a19f
#SYMVER sched_setattr_nocheck 0xccaba68c
#SYMVER sched_setscheduler_nocheck 0x22cd72b4
#SYMVER sched_set_fifo 0xa051a7a2
#SYMVER sched_set_fifo_low 0xaf38928a
#SYMVER sched_set_normal 0x2cf1da8c
...
#SYMVER yield_to 0xa2483799
#SYMVER io_schedule_timeout 0xfbc4f89e
#SYMVER io_schedule 0x93a6e0b2
#SYMVER sched_show_task 0xe821431f
#SYMVER pick_migrate_task 0x3e066a42
#SYMVER root_task_group 0xe6c03880
#SYMVER task_groups 0x56c9332f
