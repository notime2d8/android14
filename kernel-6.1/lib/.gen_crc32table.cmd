cmd_lib/gen_crc32table := clang -Wp,-MMD,lib/.gen_crc32table.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu11       -o lib/gen_crc32table lib/gen_crc32table.c   
