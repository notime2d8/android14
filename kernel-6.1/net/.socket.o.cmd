...
$(deps_net/socket.o):
#SYMVER sock_alloc_file 0xe5a5909d
#SYMVER sock_from_file 0xae74c834
#SYMVER sockfd_lookup 0x5aad7940
#SYMVER sock_alloc 0x5e99f1b7
#SYMVER sock_release 0xd5efb70f
#SYMVER __sock_tx_timestamp 0x437a0d6d
#SYMVER sock_sendmsg 0x9a8b39f8
#SYMVER kernel_sendmsg 0xfd459991
#SYMVER kernel_sendmsg_locked 0x5d0adef5
#SYMVER __sock_recv_timestamp 0x16c28ec2
#SYMVER __sock_recv_wifi_status 0xf659b27b
#SYMVER __sock_recv_cmsgs 0x1c0b89e4
#SYMVER sock_recvmsg 0xd98191fc
#SYMVER kernel_recvmsg 0x49747ae5
#SYMVER brioctl_set 0x6ac34584
#SYMVER vlan_ioctl_set 0x2646129a
#SYMVER sock_create_lite 0x87babf92
#SYMVER sock_wake_async 0xfd6cee9f
#SYMVER __sock_create 0x11a54ab4
#SYMVER sock_create 0x8e704f8c
#SYMVER sock_create_kern 0xf610145b
#SYMVER sock_register 0x993f9ceb
#SYMVER sock_unregister 0x62737e1d
#SYMVER get_user_ifreq 0x33fc2a31
#SYMVER put_user_ifreq 0x38f48af7
#SYMVER kernel_bind 0x600cfea5
#SYMVER kernel_listen 0xaffd9c96
#SYMVER kernel_accept 0xcf52ef3e
#SYMVER kernel_connect 0x9fac700a
#SYMVER kernel_getsockname 0xa6d2d984
#SYMVER kernel_getpeername 0xbfe00c2e
#SYMVER kernel_sendpage 0xcacec9d6
#SYMVER kernel_sendpage_locked 0x7231eb22
#SYMVER kernel_sock_shutdown 0xead38925
#SYMVER kernel_sock_ip_overhead 0x322d3174
