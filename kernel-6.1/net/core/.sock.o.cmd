...
$(deps_net/core/sock.o):
#SYMVER sk_ns_capable 0xf8932f58
#SYMVER sk_capable 0x3c96dd18
#SYMVER sk_net_capable 0x81cb21dc
#SYMVER sysctl_wmem_max 0xfac8865f
#SYMVER sysctl_rmem_max 0xb05fc310
#SYMVER sysctl_optmem_max 0xa108eb4d
#SYMVER memalloc_socks_key 0x77ecf68d
#SYMVER sk_set_memalloc 0x7af3a77e
#SYMVER sk_clear_memalloc 0x3bb4f44d
#SYMVER __sk_backlog_rcv 0xa5e81722
#SYMVER sk_error_report 0xf55968f8
#SYMVER sock_get_timeout 0xedd17b31
#SYMVER sock_copy_user_timeval 0x5bdb7603
#SYMVER __sock_queue_rcv_skb 0xf2231e54
#SYMVER sock_queue_rcv_skb_reason 0x1729491b
#SYMVER __sk_receive_skb 0x8cd64a0a
#SYMVER __sk_dst_check 0x0ec010b8
#SYMVER sk_dst_check 0x54d84381
#SYMVER sock_bindtoindex 0x16f2a276
#SYMVER sk_mc_loop 0x419535d6
#SYMVER sock_set_reuseaddr 0x3477946c
#SYMVER sock_set_reuseport 0xad82b88a
#SYMVER sock_no_linger 0x91c124e9
#SYMVER sock_set_priority 0x88f6e5ed
#SYMVER sock_set_sndtimeo 0xf0269c75
#SYMVER sock_enable_timestamps 0x76a06029
#SYMVER sock_set_keepalive 0x698f434b
#SYMVER sock_set_rcvbuf 0xbf88e14c
#SYMVER sock_set_mark 0x329f4b7e
#SYMVER sockopt_lock_sock 0x83746194
#SYMVER sockopt_release_sock 0x55e86768
#SYMVER sockopt_ns_capable 0x92ab0f12
#SYMVER sockopt_capable 0x2a6a5aac
#SYMVER sock_setsockopt 0x29786b16
#SYMVER sk_alloc 0xfac80a85
#SYMVER sk_free 0xc00c5dc9
#SYMVER sk_clone_lock 0xc7fff739
#SYMVER sk_free_unlock_clone 0x1e8fe5ca
#SYMVER sk_setup_caps 0x1d9312a4
#SYMVER sock_wfree 0x7478d470
#SYMVER skb_set_owner_w 0xc2a95e99
#SYMVER skb_orphan_partial 0x16ac7504
#SYMVER sock_rfree 0x0c6bf33c
#SYMVER sock_efree 0x1f588a89
#SYMVER sock_pfree 0x3c60b044
#SYMVER sock_i_uid 0xfe16d4d6
#SYMVER __sock_i_ino 0xe732a7bf
#SYMVER sock_i_ino 0xa6dc619a
#SYMVER sock_wmalloc 0x6d120542
#SYMVER sock_kmalloc 0x93d6a835
#SYMVER sock_kfree_s 0xd2790ae4
#SYMVER sock_kzfree_s 0x7d8c2556
#SYMVER sock_alloc_send_pskb 0x8f982d22
#SYMVER __sock_cmsg_send 0x08cc93e9
#SYMVER sock_cmsg_send 0x5f7f0dc9
#SYMVER skb_page_frag_refill 0x3a67bb9e
#SYMVER sk_page_frag_refill 0x2e24c2bd
#SYMVER __sk_flush_backlog 0xea1aa108
#SYMVER sk_wait_data 0x27ed14ea
#SYMVER __sk_mem_schedule 0x64100a52
#SYMVER __sk_mem_reclaim 0x61db4642
#SYMVER sk_set_peek_off 0xf7e746e8
#SYMVER sock_no_bind 0xa499aed2
#SYMVER sock_no_connect 0x4d071e59
#SYMVER sock_no_socketpair 0x82f35801
#SYMVER sock_no_accept 0xdd97de37
#SYMVER sock_no_getname 0xf1db506a
#SYMVER sock_no_ioctl 0xd780113a
#SYMVER sock_no_listen 0x72f9c8a0
#SYMVER sock_no_shutdown 0x4a5c92b4
#SYMVER sock_no_sendmsg 0xd64069aa
#SYMVER sock_no_sendmsg_locked 0xc89daecf
#SYMVER sock_no_recvmsg 0x6189645e
#SYMVER sock_no_mmap 0x54a8263c
#SYMVER sock_no_sendpage 0xd4e19b57
#SYMVER sock_no_sendpage_locked 0xc7802871
#SYMVER sk_send_sigurg 0xa3c3829e
#SYMVER sk_reset_timer 0x0772fe17
#SYMVER sk_stop_timer 0x9b5de962
#SYMVER sk_stop_timer_sync 0x7ef56c6d
#SYMVER sock_init_data_uid 0xe01e7da9
#SYMVER sock_init_data 0x2b71cca9
#SYMVER lock_sock_nested 0x6191c143
#SYMVER release_sock 0xf3e86b68
#SYMVER __lock_sock_fast 0x5d490ee7
#SYMVER sock_gettstamp 0x11b456d2
#SYMVER sock_recv_errqueue 0xf5105632
#SYMVER sock_common_getsockopt 0x07b03d71
#SYMVER sock_common_recvmsg 0xdef16439
#SYMVER sock_common_setsockopt 0x3b8a5c26
#SYMVER sk_common_release 0x54664f5e
#SYMVER sock_prot_inuse_get 0x28d3a896
#SYMVER sock_inuse_get 0x7592ca33
#SYMVER proto_register 0x21730d7e
#SYMVER proto_unregister 0x64b0f2ff
#SYMVER sock_load_diag_module 0xf665f74f
#SYMVER sk_busy_loop_end 0xe590dea3
#SYMVER sock_bind_add 0x5b56d277
