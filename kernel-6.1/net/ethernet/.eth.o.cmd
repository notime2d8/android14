...
$(deps_net/ethernet/eth.o):
#SYMVER eth_header 0x3c5e6df5
#SYMVER eth_get_headlen 0xf2b1f5f7
#SYMVER eth_type_trans 0x14e79658
#SYMVER eth_header_parse 0x666ee834
#SYMVER eth_header_cache 0x163d861f
#SYMVER eth_header_cache_update 0x59c1ecc9
#SYMVER eth_header_parse_protocol 0x208d0376
#SYMVER eth_prepare_mac_addr_change 0x1d255a01
#SYMVER eth_commit_mac_addr_change 0x97a90ab6
#SYMVER eth_mac_addr 0x0831fb91
#SYMVER eth_validate_addr 0xe7aaeef4
#SYMVER ether_setup 0xaf276687
#SYMVER alloc_etherdev_mqs 0xe736beae
#SYMVER sysfs_format_mac 0x81533963
#SYMVER eth_gro_receive 0x2a33638e
#SYMVER eth_gro_complete 0x9523fd82
#SYMVER eth_platform_get_mac_address 0x016b6de9
#SYMVER platform_get_ethdev_address 0x7d7a87a9
#SYMVER fwnode_get_mac_address 0x46406fbc
#SYMVER device_get_mac_address 0x78ab0188
#SYMVER device_get_ethdev_address 0x0c20b5b2
