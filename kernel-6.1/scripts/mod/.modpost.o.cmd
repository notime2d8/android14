cmd_scripts/mod/modpost.o := clang -Wp,-MMD,scripts/mod/.modpost.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu11     -c -o scripts/mod/modpost.o scripts/mod/modpost.c
